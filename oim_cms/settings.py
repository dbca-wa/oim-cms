...
LDAP_ACCESS_DN = env('LDAP_ACCESS_DN')
LDAP_ACCESS_PASSWORD = env('LDAP_ACCESS_PASSWORD')
LDAP_SEARCH_SCOPE = env('LDAP_SEARCH_SCOPE')
import ldap
...
SOCIAL_AUTH_AZUREAD_OAUTH2_KEY = env('AZUREAD_CLIENTID')
SOCIAL_AUTH_AZUREAD_OAUTH2_SECRET = env('AZUREAD_SECRETKEY')
...
SESSION_COOKIE_DOMAIN = env('SESSION_COOKIE_DOMAIN', 'sessionid')
