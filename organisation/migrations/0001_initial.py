    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.CharField(blank=True, help_text="HR Employee ID, use 'n/a' if a contractor", max_length=128, null=True, unique=True, verbose_name='Employee ID')),
                ('username', models.CharField(editable=False, max_length=128, unique=True)),
                ('name', models.CharField(help_text='Format: Surname, Given name', max_length=128)),
                ...
                ('date_ad_updated', models.DateTimeField(editable=False, null=True, verbose_name='Date AD updated')),
                ...
                ('notes', models.TextField(blank=True, help_text='Officer secondary roles, etc.', null=True)),
                ...
                ('account_type', models.PositiveSmallIntegerField(blank=True, choices=[(3, 'Agency contract'), (0, 'Department fixed-term contract'), (1, 'Other'), (2, 'Permanent'), (4, 'Resigned'), (9, 'Role-based account'), (8, 'Seasonal'), (5, 'Shared account'), (6, 'Vendor'), (7, 'Volunteer')], help_text='Employee account status (should match Alesco status)', null=True)),
                ...
                ('cost_centres_secondary', models.ManyToManyField(blank=True, related_name='cost_centres_secondary', to='organisation.CostCentre')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unit_type', models.PositiveSmallIntegerField(choices=[(0, 'Department'), (1, 'Division'), (2, 'Branch'), (3, 'Region'), (4, 'Cost Centre'), (5, 'Office'), (6, 'District'), (7, 'Section'), (8, 'Unit'), (9, 'Group'), (10, 'Work centre')], default=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fax', models.CharField(blank=True, max_length=128, null=True)),
                ('email', models.CharField(blank=True, max_length=128, null=True)),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organisation.Location')),
                ('manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='organisation.DepartmentUser')),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.AddField(
            ...
            name='org_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='organisation.OrgUnit', verbose_name='organisational unit'),
        ),
        migrations.AddField(
            model_name='departmentuser',
            name='org_units_secondary',
            field=models.ManyToManyField(blank=True, related_name='org_units_secondary', to='organisation.OrgUnit'),
        ),
        migrations.AddField(
            model_name='departmentuser',
            name='parent',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='organisation.Location'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='costcentre',
            name='division',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='costcentres_in_division', to='organisation.OrgUnit'),
        ),
        migrations.AddField(
            model_name='costcentre',
            name='manager',
        ...
        migrations.AddField(
            model_name='costcentre',
            name='org_position',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organisation.OrgUnit'),
        ),
        migrations.AddField(
            model_name='costcentre',
            name='tech_contact',
